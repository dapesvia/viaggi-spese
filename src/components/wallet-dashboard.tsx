...
export function WalletDashboard({ currentUser }: WalletDashboardProps) {
  ...
  const alexTotal = expenses
    .filter(e => e.paid_by_user_id === "alex")
    .reduce((sum, e) => sum + e.amount_in_eur, 0);
  const valentinaTotal = expenses
    .filter(e => e.paid_by_user_id === "valentina")
    .reduce((sum, e) => sum + e.amount_in_eur, 0);
  
  const balance = currentUser === "alex" 
    ? alexTotal - valentinaTotal 
    : valentinaTotal - alexTotal;
        ...
        <div className="flex items-center justify-center gap-3">
          {balance > 0 ? (
            <>
              ...
              <p className="text-xl">
                {currentUser === "alex" ? "Valentina" : "Alex"} ti deve{" "}
            ...
            <>
              ...
              <p className="text-xl">
                Tu devi a {currentUser === "alex" ? "Valentina" : "Alex"}{" "}
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Pagato da {expense.paid_by_user_id === "alex" ? "Alex" : "Valentina"} •{" "}
